...
{
public:
	std::string		m_name;			// Name of this location, nullptr indicates end of the array
...
public:
	VertexDefinition( std::string const name, unsigned int bindPoint, int count, VertexDataType const &type, bool normalized, int stride, int offset );
	~VertexDefinition();
};