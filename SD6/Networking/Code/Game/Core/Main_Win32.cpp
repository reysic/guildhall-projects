...
const int WINDOW_PHYSICAL_WIDTH = 1067;
const int WINDOW_PHYSICAL_HEIGHT = 600;
...
const char* APP_NAME = "SD6 - Jeremy Hicks";
...
void Update()
{
	...
	g_theNetworkingSystem->Update( deltaSeconds );
...
void Initialize( HINSTANCE applicationInstanceHandle )
{
	...
	g_theNetworkingSystem = new NetworkingSystem();
	g_theApp = new TheApp();
	g_theGame = new TheGame();

	// Automatically join or create TCP listen socket on startup
	g_theDeveloperConsole->ExecuteCommand( "join " + std::string( g_theNetworkingSystem->GetLocalHostName() ) );
	g_theDeveloperConsole->ExecuteCommand( "host" );
	g_theDeveloperConsole->ExecuteCommand( "net_session_start" );
}
...
void Shutdown()
{
	...
	delete g_theNetworkingSystem;
	g_theNetworkingSystem = nullptr;
	delete g_theGame;
	g_theGame = nullptr;
	delete g_theApp;
	g_theApp = nullptr;
