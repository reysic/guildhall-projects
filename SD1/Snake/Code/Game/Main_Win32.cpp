...
const char* APP_NAME = "Snake by Jeremy Hicks";
...
void Initialize( HINSTANCE applicationInstanceHandle )
{
	...
	g_theRenderer->SetOrtho( Vector2( 0.0f, 0.0f ), Vector2( 900.0f, 900.0f ) );
...
int WINAPI WinMain( HINSTANCE applicationInstanceHandle, HINSTANCE, LPSTR commandLineString, int )
{
	...
	while ( !g_isQuitting  && !( g_theApp->m_shutdown) )
	{
		RunFrame();
	}
